...
extension Localized {
  enum Extension {
    ...
    static let unreviewedWarning = String(localized: "This source is not reviewed by kmd. Only continue if you trust it.", comment: "Caution shown before installing an extension from a raw URL")
    static let installedTitle = String(localized: "Extension Installed", comment: "Title for the extension installed confirmation")
    static let installedMessageFormat = String(localized: "Relaunch kmd to start using “%@”.", comment: "Message (format) shown after an extension is installed")
    ...
    static let incompatibleFormat = String(localized: "This extension requires kmd %@ or later.", comment: "Error (format) when an extension needs a newer app version")
    ...
    static let updatedMessage = String(localized: "Relaunch kmd to use the updated extensions.", comment: "Message shown after extensions are updated")

    // MARK: - Extensions UI

    static let windowTitle = String(localized: "kmd Extensions", comment: "Title of the extension manager window")
